 ...
 */
 ...
 {	
 	...
 	System.out.println("Bubba had some friends over for a cookout. He" +
 		...
 		"apiece, chicken for $1.85 each, buns for 25 cents each, and" +
 		"cheese for 10 cents each." // apiece should be a piece but copied as it is shown in the email
 	...
 	System.out.println("The Smith family got their food first." +
 		"Billy had two hot dogs with buns," smithBun + 2, smithHotDog + 2)
 	System.out.println("Judy had a piece of chicken, and Bob had two cheeseburgers" +
 		 "and a hot dog, all with buns." ++smithChicken, smithBun + 3,smithBurger +2, +
 		 "Totals for the Smith family are shown below. ")
